...
// Asyn load images
document.write('<img style="display: none" src="http://localhost:4000/bugoslinux/assets/images/patterns/dark-fabric.png">');
document.write('<img style="display: none" src="http://localhost:4000/bugoslinux/assets/images/patterns/dark-fabric.png">');

// Load theme dark-light
if (typeof(Storage) !== "undefined") {
    if (sessionStorage.theme == "dark") {
        $('body').css("background", "url(http://localhost:4000/bugoslinux/assets/images/patterns/dark-fabric.png)");
...
$(document).ready(function(){
    ...
    $('input#theme-select').change(function(){
        if ($('input#theme-select').is(':checked')) {
            ...
            $('body').css("background", "url(http://localhost:4000/bugoslinux/assets/images/patterns/seigaiha.png)");
            sessionStorage.theme = "light";
        }
    });
